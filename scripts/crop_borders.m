...
% 
% DANNY FIXES
% Removed 'padding' for left/right borders for journal publications
% JK moved it back (l-152 or l-153)
%}
    ...
    if padding > 0  % extra padding
        ...
        vB = [padding+1, (b-t)+1+padding, 1, (r-l)+1]; % No left/right padding (only top/bottom)
        ...
        %vA = [t-padding b+padding l r]; % No left/right padding (only top/bottom)
